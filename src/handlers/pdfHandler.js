/**
 * Handles PDF file uploads by sending them directly to the analyze API
 * @param {File} file - The PDF file to handle
 ...
 */
export const handlePdfFile = async (file, setFileName, setUploadStatus) => {
  if (!file) return;
